...
const getNotificationBody = list => {
  ...
  <div className="empty-notification">
    ...
    <p className="mt-3">Танд шинэ мэдэгдэл байхгүй байна</p>
  </div>;
}
  ...
  const notificationList = (
    <div className="nav-dropdown nav-notification">
      <div className="nav-notification-header d-flex justify-content-between align-items-center">
        <h4 className="mb-0">Мэдэгдэл</h4>
        <Button className="text-primary" type="text" onClick={() => setData([])} size="small">Арилгах </Button>
      </div>
      ...
      </div>
      {
        ...
        <div className="nav-notification-footer">
          <a className="d-block" href="#/">Бүгдийг харах</a>
        </div>
        :
        null
      }
