...
import { ALL_STUDENT_STATUS, DELETE_STUDENET_STATUS } from 'graphql/core'
import IntlMessage from 'components/util-components/IntlMessage';

function  StatusTable (props) {

	const { loading, error, data: statusData } = useQuery(ALL_STUDENT_STATUS, {
	});
    ...
    useEffect(() => {
        if(loading === false && statusData){
            setList(statusData?.allStudentStatuss);
        }
	...
	const [deleteActivity, { loading: loadingDelete }] = useMutation(DELETE_STUDENET_STATUS, {
	...
	const onSearch = e => {
		...
		const searchArray = e.currentTarget.value? list : statusData?.allStudentStatuss
