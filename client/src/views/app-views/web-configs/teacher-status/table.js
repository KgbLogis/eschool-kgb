...
import { ALL_TEACHER_STATUS, DELETE_STEACHER_STATUS } from 'graphql/core'
import IntlMessage from 'components/util-components/IntlMessage';

function  StatusTable (props) {

	const { loading, error, data: statusData } = useQuery(ALL_TEACHER_STATUS, {
	});
    ...
    useEffect(() => {
        if(loading === false && statusData){
            setList(statusData?.allTeacherStatuss);
        }
	...
	const [deleteActivity, { loading: loadingDelete }] = useMutation(DELETE_STEACHER_STATUS, {
