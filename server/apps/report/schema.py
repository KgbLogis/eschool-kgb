...
class Query(graphene.ObjectType):
    ...
    markcon_subject = graphene.List(Markcon_subjectType, section=graphene.Int(required=True), schoolyear=graphene.Int(required=True))
    ...
    def resolve_student_mark_report(self, info, student_code):
      ...
      return {
        ...
        "text_mid7": program.degree,"text_bottom":program.report_text,"student_photo":"/media/"+str(student.photo),"student_code":student.student_code}
    ...
    def resolve_markcon_subject(self, info, section, schoolyear):
      reports = []
      ...
      if schoolyear == 0:
        ...
        subjects = Mark_board.objects.filter(pk__in=mark_boards, schoolyear_id=schoolyear).values('subject_id')
    ...
    def resolve_mark_con(self, info, subject, schoolyear, student):
      if schoolyear == 0:
        ...
        try:
          ...
          return {"percentage":'',"type":'F',"diam":'0'}
