...
class CreateMark_board(graphene.Mutation):
    ...
    def mutate(self, info, schoolyear, subject, teacher, start_at, end_at, status):
        ...
        mark_board_o = Mark_board(schoolyear=schoolyear_i, subject=subject_i, teacher=teacher_i, start_at=start_at, end_at=end_at, status=status, create_userID=create_userID_i)
        mark_board_o.save()
...
class CreateMark_board_from_routine(graphene.Mutation):
    ...
    def mutate(self, info, routine, start_at, end_at, status):
        ...
        mark_board_o = Mark_board(schoolyear=routine.schoolyear, subject=routine.subject, teacher=routine.teacher, start_at=start_at, end_at=end_at, status=status, create_userID=create_userID_i)
        mark_board_o.save()
...
class CreateMark_setting(graphene.Mutation):
    ...
    def mutate(self, info, name, percentage):
        
        create_userID_i = info.context.user

        mark_setting = Mark_setting(name=name, percentage=percentage, create_userID=create_userID_i)
        mark_setting.save()
...
class UpdateMark_setting(graphene.Mutation):
    ...
    def mutate(self, info, name, percentage, id):
