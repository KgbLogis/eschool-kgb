...
from .models import Program, Program_subject
...
class CreateProgram(graphene.Mutation):
    ...
    def mutate(self, info, program, program_mgl, max_student_num, sub_school, school, status):
        ...
        pro = Program(program=program, program_mgl=program_mgl, max_student_num=max_student_num, sub_school=sub_school_i, school=school_i, status=status, create_userID=create_userID_i)
        pro.save()
        return CreateProgram(program=pro)

        #  program_numeric=program_numeric,
...
class UpdateProgram(graphene.Mutation):
    ...
    def mutate(self, info, program, program_mgl, max_student_num, sub_school, school, status, id):
